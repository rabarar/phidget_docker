...
Phidget_enumFromString(const char *name) {
	...
	if (mos_strcasecmp(name, "PHIDID_MESHHUB") == 0)
		return (65);

	if (mos_strcasecmp(name, "PHIDID_MESHDONGLE") == 0)
		return (66);

	if (mos_strcasecmp(name, "PHIDID_HUB0004") == 0)
		return (67);

	if (mos_strcasecmp(name, "PHIDID_LIGHTNINGHUB") == 0)
		return (68);
	...
	if (mos_strcasecmp(name, "PHIDID_MOT0108") == 0)
		return (131);
	...
	if (mos_strcasecmp(name, "PHIDID_MOT0110") == 0)
		return (141);
	...
	if (mos_strcasecmp(name, "PHIDID_DAQ0501") == 0)
		return (144);
...
supportedDeviceID(PhidgetChannelHandle ch, Phidget_DeviceID val) {
	...
	case PHIDCHUID_DAQ0501_VOLTAGERATIOINPUT_200:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_DAQ0501:
			return (1);
	...
	case PHIDCHUID_ADP1001_DIGITALINPUT_DSR_100_USB:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_ADP1001:
			return (1);
	...
	case PHIDCHUID_ADP1001_DIGITALINPUT_DCD_100_USB:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_ADP1001:
			return (1);
	...
	case PHIDCHUID_ADP1001_DIGITALINPUT_RI_100_USB:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_ADP1001:
			return (1);
	...
	case PHIDCHUID_ADP1001_DIGITALOUTPUT_DTR_100_USB:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_ADP1001:
			return (1);
	...
	case PHIDCHUID_MOT0108_GYROSCOPE_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_MOT0108:
			return (1);
	...
	case PHIDCHUID_MOT0108_MAGNETOMETER_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_MOT0108:
			return (1);
	...
	case PHIDCHUID_MOT0108_SPATIAL_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_MOT0108:
			return (1);
	...
	case PHIDCHUID_MOT0108_TEMPERATURESENSOR_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_MOT0108:
			return (1);
	...
	case PHIDCHUID_MOT0110_GYROSCOPE_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_MOT0110:
			return (1);
	...
	case PHIDCHUID_MOT0110_MAGNETOMETER_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_MOT0110:
			return (1);
	...
	case PHIDCHUID_MOT0110_SPATIAL_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_MOT0110:
			return (1);
	...
	case PHIDCHUID_MOT0110_TEMPERATURESENSOR_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_MOT0110:
			return (1);
	...
	case PHIDCHUID_HUB0001_OLDPROTO_GENERIC:
		switch (val) {
		case PHIDID_NOTHING:
	...
	case PHIDCHUID_MESHDONGLE_MESHDONGLE_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_MESHDONGLE:
			return (1);
		default:
			return (0);
		}
	...
	case PHIDCHUID_LIGHTNINGHUB_HUB_100:
		switch (val) {
		case PHIDID_NOTHING:
		case PHIDID_LIGHTNINGHUB:
			return (1);
		default:
			return (0);
		}
