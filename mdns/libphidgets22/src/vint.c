...
Phidget_setHubPortSpeed_internal(mosiop_t iop, PhidgetChannelHandle channel, uint32_t speed) {
	...
	#define NUM_VINT_SUPPORTED_SPEEDS	10
	uint32_t supportedSpeeds[NUM_VINT_SUPPORTED_SPEEDS] = { 10000, 25000, 50000, 100000, 160000, 250000, 400000, 500000, 800000, 1000000 };
	 ...
	 *  10000, 25000, 50000, 100000, 160000, 250000, 400000, 500000, 800000, 1000000
	 * This is determined by finding the common factors of the various clock (UART CLK) speeds:
	 *  4MHx, 8MHx, 12MHz, 16MHz, 36MHz, 48MHz
	 */
