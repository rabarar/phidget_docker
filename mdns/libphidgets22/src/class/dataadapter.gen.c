/* Generated: Fri Feb 11 2022 13:52:25 GMT-0700 (Mountain Standard Time) */
...
_initAfterOpen(PhidgetChannelHandle phid) {
	...
	case PHIDCHUID_ADP1001_DATAADAPTER_100_USB:
		...
		ch->responseTimeout = 1000;
		ch->transmitTimeout = 0;
		ch->minResponseTimeout = 10;
		ch->maxResponseTimeout = 60000;
		ch->minTransmitTimeout = 100;
		ch->maxTransmitTimeout = 50000;
